...
//	int size = 2;
//	listinsert(mylist, 2, &size);
//	listinsert(mylist, 14, &size);
//	listinsert(mylist, 9, &size);
//	printlist(mylist->head, size);
//	node* find = search(mylist->head, 15);
//	printf("\nfound %d", find->value);	
//}
...
int main() {
	...
	int size = 2;
	node* newnode;
	newnode = buildnode(10, NULL, NULL);
	//printlist(mylist->head, 2);
	//listinsert(mylist, 2, &size);
	//listinsert(mylist, 14, &size);
	//listinsert(mylist, 9, &size);
	//printlist(mylist->head, size);
